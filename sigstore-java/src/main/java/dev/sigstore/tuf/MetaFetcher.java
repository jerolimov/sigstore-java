...
public interface MetaFetcher {
   ...
   *
   * @throws FileExceedsMaxLengthException when the retrieved file is larger than the maximum allowed
   *     by the client
   */
  ...
  byte[] fetchResource(String filename, int maxLength) throws IOException, FileExceedsMaxLengthException;
}
